...
export function CameraPanel(): JSX.Element {
  ...
  return (
    <div className="flex h-28 shrink-0 flex-col border-t border-neutral-800 bg-neutral-900">
      <div className="flex items-center justify-between px-3 py-2">
        <h2 className="text-xs font-semibold uppercase tracking-wide text-neutral-500">Cameras</h2>
        <button
          ...
          <div className="flex h-full gap-2">
            {devices.map((device) => (
              <div
                ...
                title={device.label}
                className="flex w-28 shrink-0 cursor-grab flex-col items-center justify-center gap-1 rounded border border-neutral-800 bg-neutral-950 p-2"
              >
